...
- The current implementation of LandR Biomass model (based on LANDIS-II) uses a "reduced" data structure throughout
...
- AFTER that, then you can use 2 great tools:
    ...
    - `profvis` package (built into the latest Rstudio)
...
Recent versions of Rstudio version have 'Profile' as a menu item.
