...
downloadData("LccToBeaconsReclassify")
```
...
downloadData("cropReprojectLccAge") # Note that there is an error in the end of this download (at the last file). This is related to a missing map that we will fix below
```

Unfortunately, the forest age raster ("can_age04_1km.tif") is no longer downloadable without creating an account on the NASA EarthData website. Download it from [here](https://drive.google.com/file/d/1bD957dewv3U-cbISfeUEz1QpGg5DurR-/view?usp=sharing) and put in inside *modules/cropReprojectLccAge/data* and *modules/forestAge/data* (this will only be possible during the workshop).  
...
<img src="images/Feb2018_Day1/LCC2005_plot.png" align="middle" height="400" width="400" margin="0 auto" />
...
<img src="images/Feb2018_Day1/LCC2005harvest_plot.png" align="middle" height="400" width="400" margin="0 auto" />
...
<!-- ```{r LBMR} -->
<!-- ## get LBMR module - note: this is temporary as this module is yet unpublished -->
<!-- downloadModule("LBMR", repo = "eliot/SpaDES-modules", path = getPaths()$modulePath, data = TRUE, overwrite = TRUE) -->
...
<!-- <img src="images/Feb2018_Day1/LBMR_plot.png" align="middle" height="400" width="400" margin="0 auto" /> -->
