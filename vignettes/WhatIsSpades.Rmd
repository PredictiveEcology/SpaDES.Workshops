...
downloadModule('LCC2005', path = getPaths()$modulePath, repo = 'CeresBarros/SpaDES-modules', data = TRUE, overwrite = TRUE)
...
table(ageMap01[])
Plot(hist(ageMap01[]), title = "Age distribution")
```
...
downloadModule("LBMR", repo = "CeresBarros/SpaDES-modules", path = getPaths()$modulePath, data = TRUE, overwrite = TRUE)
