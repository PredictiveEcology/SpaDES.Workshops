...
# 2. Copy this file to the tests folder (i.e., `C:/Eliot/GitHub/SpaDES.Workshops/docs/articles/modules/speciesAbundance/tests/testthat`).
...
test_that("test Event1 and Event2.", {
  ...
  path <- list(modulePath = "C:/Eliot/GitHub/SpaDES.Workshops/docs/articles/modules",
