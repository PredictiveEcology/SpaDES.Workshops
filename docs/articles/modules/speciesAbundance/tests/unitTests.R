...
test_dir("C:/Eliot/GitHub/SpaDES.Workshops/docs/articles/modules/speciesAbundance/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Eliot/GitHub/SpaDES.Workshops/docs/articles/modules/speciesAbundance/tests/testthat/test-template.R")
