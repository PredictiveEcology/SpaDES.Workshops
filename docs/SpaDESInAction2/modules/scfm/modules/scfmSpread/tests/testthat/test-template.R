...
# 2. copy this file to tests folder, i.e., `/Users/stevec/Dropbox/Courses/7043H16/Lab/scfmModules/scfmSpread/tests`.
...
parameters <- list(
  ...
  scfmSpread = list(.saveInitialTime = NA)
)
